...
export default function TabsLayout(){return <Tabs screenOptions={{headerShown:true,tabBarActiveTintColor:'#111827'}}>
<Tabs.Screen name="home" options={{title:'Ana Sayfa',tabBarLabel:'Ana'}}/>
...
<Tabs.Screen name="reports" options={{title:'Raporlar',tabBarLabel:'Rapor'}}/>
</Tabs>}
